...
public class SearchStudent extends javax.swing.JFrame {
    ...
    String studentId, studentName, fatherName, address, phoneNo, course, booksIssued, status;
    ...
    public SearchStudent(String studentId) {
        try {
            conn = dbhandler.getDbConnection();
        } catch (SQLException ex) {
            ex.printStackTrace();
    ...
    private void setDataTable() {
        ...
        try {
            ...
            while (rst.next()) {
                ...
                booksIssued = rst.getString("booksIssued");
                status = rst.getString("studentStatus");

                Object[] obj = {studentId, studentName, fatherName, address, phoneNo, course, booksIssued, status};
    ...
    private void initComponents() {
        ...
        viewAllDetailsLabel.setText("Search Student");
        ...
        upperPanel.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 150, -1, -1));
        ...
        dataTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Name", "Father's Name", "Address", "Phone No.", "Course", "Books Issued", "Status"
            }
        ) {
        ...
        dataTable.setColorBackgoundHead(new java.awt.Color(0, 102, 102));
        ...
        if (dataTable.getColumnModel().getColumnCount() > 0) {
            ...
            dataTable.getColumnModel().getColumn(3).setMinWidth(35);
            dataTable.getColumnModel().getColumn(3).setPreferredWidth(80);
            dataTable.getColumnModel().getColumn(4).setPreferredWidth(25);
            dataTable.getColumnModel().getColumn(5).setPreferredWidth(15);
            dataTable.getColumnModel().getColumn(6).setPreferredWidth(15);
            dataTable.getColumnModel().getColumn(7).setPreferredWidth(15);
        }
